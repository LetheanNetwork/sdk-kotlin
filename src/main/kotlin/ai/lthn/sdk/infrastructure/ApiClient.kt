...
import ai.lthn.sdk.auth.HttpBearerAuth
...
import ai.lthn.sdk.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "ai.lthn.sdk.baseUrl"
        @Deprecated(
